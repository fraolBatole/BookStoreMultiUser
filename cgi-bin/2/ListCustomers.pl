      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">View Profile</a>
          </div>
              ...
              <li class="nav-item btn-rotate dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                  ...
                  <a class="dropdown-item"
                    href="http://undcemcs02.und.edu/~fraol.ahmed/cgi-bin/513/2/DisplayCode.cgi?act=4">Display Code</a>
                  <a class="dropdown-item"
...
ENDOFTAG
	$id = $query -> param("id");
	if($id ne null){
		$cmd = "/usr/bin/java -Djava.security.egd=file:/dev/./urandom ListCustomers $uname $id";
	}else {
		$cmd = "/usr/bin/java -Djava.security.egd=file:/dev/./urandom ListCustomers $uname";
	}
	system($cmd);
print <<ENDOFTAG;
                      </div>
